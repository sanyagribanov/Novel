...
label day_1:
    ...
    $ AddAchieve ("Хранительница очага", "Вы познакомились с Мартой")
...
label molchat:
    $ AddAchieve ("Психолог", "Вы выслушали Марту")
    ...
    $ AddAchieve ("Спокойная ночь", "Вы провели первую ночь в путешествии")
    stop music fadeout 1
