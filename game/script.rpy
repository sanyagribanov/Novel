...
label no:
    "Впрочем, я не могу быть точно уверена в том, что они меня не обманут"
    "Я вижу их впервые, и поверить на слово я им не могу"
    "Но на лице девушки видно волнение. Будто я ее младшая сестра, идущая одна в лес по ягоды"
    show martha sad
    ...
    "Странные чувства вызвал молчаливый повозчик. То, что он не заговорил, можно списать на какой-нибудь травмирующий опыт в его жизни"
    "Но меня волновало другое. За все время он даже в мою сторону не глянул. Его непонятная мрачность меня пугает"
    "Впрочем, это не важно, надо продолжать путь"
    play nature "audio/grass-steps.ogg"
    "Хоть летом солнце светит до глубокой ночи, нужно поторопиться и дойти до деревни"
    "..."
    "Полчаса ходьбы дались мне с некой утомленностью. Учитывая то, что я была в путь почти полдня, это не удивительно"
    "Хоть в ногах была усталость, но, увидев вдалеке деревенские домики, появилось желание ижти дальше. Еще немного, и можно будет заночевать"
    #звук шагов разбойника
    "Судя по шороху неподалеку, я здесь не одна. Кто-то либо преследовал меня, либо поджидал"
    "Надо бежать!"
    "ПРЯМО СЕЙЧАС!"
    v "Слышь, а ну остановилась!"
    "Голос довольно моложавый, еще недостаточно погрубел. Но уже таким занимается. У этого парня явно жизнь не сахар"
    v "Захотела побегать, сучка?! Бесполезно, те хана в любом случае"
    "Парень уже был на хвосте, его шаги слышались довольно отчетливо. Интересно, сколько еще он способен бежать. Но и мне осталось не так уж и много, я скоро выдохнусь"
    "Надо спрятаться и быстро взять нож из сумки. Убить не убью, но хотя бы..."
    #грохот на землю
    "Толчок в спину, и я уже на земле. Сейчас наверняка попытается ударить, чтобы обездвижить меня"
    c "Черта с два я тебе дамся, подонок!"
    "Пинком я оттолкнула его на определенное расстояние от себя"
